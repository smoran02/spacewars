#############################################################################
# Makefile for building: homework3
# Generated by qmake (2.01a) (Qt 4.8.1) on: Wed Aug 7 16:31:19 2013
# Project:  homework3.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile homework3.pro
#############################################################################
...
Makefile: homework3.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -o Makefile homework3.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/homework31.0.0 || $(MKDIR) .tmp/homework31.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/homework31.0.0/ && $(COPY_FILE) --parents badguy.h bullet.h database.h linkedlist.h powerup.h spaceship.h spacewars.h user.h .tmp/homework31.0.0/ && $(COPY_FILE) --parents badguy.cpp bullet.cpp collisions.cpp database.cpp explosions.cpp moveBullets.cpp powerup.cpp Qt.cpp spaceship.cpp spacewars.cpp user.cpp .tmp/homework31.0.0/ && (cd `dirname .tmp/homework31.0.0` && $(TAR) homework31.0.0.tar homework31.0.0 && $(COMPRESS) homework31.0.0.tar) && $(MOVE) `dirname .tmp/homework31.0.0`/homework31.0.0.tar.gz . && $(DEL_FILE) -r .tmp/homework31.0.0
